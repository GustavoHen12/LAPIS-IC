...
class Janela:
    ...
    def __init__(self, root):
        ...
        self.filemenu.add_separator()#separado entre os comandos
        self.filemenu.add_command(label="Undo", command= lambda: ferramentas.undo())
        self.filemenu.add_separator()#separado entre os comandos
        ...
        altb = 70
        largb = 70
        processicon = Image.open('process5.png')
        altb, largb, processicon = self.icones(altb, largb, processicon)
        #criae configura o botão self.processb (Process), associando ele ao método process
        self.processb= Button (self.root, height = altb, width = largb, relief = 'flat', command = lambda: filtrosb.canny())
        ...
        #Botão Import
        importicon = Image.open ("import2.png")
        altb = 40
        largb = 50
        ...
        #Botão Draw
        lapisicon = Image.open ( "desenha3.png")
        altb = 40
        largb = 50
        ...
        #Botão Crop
        cortaricon = Image.open ( "cortar2.png")
        altb = 40
        largb = 50
        ...
        #Botão Gamma
        f2icon = Image.open ( "filtro22.png")
        altb = 40
        largb = 50
        ...
        #Botão de threshold
        threshicon = Image.open ( "binery3.png")
        altb = 40
        largb = 50
        ...
        #Botão invert
        inverticon = Image.open ( "invert2.png")
        altb = 40
        largb = 50
        ...
        #Botão zoom in
        zoominicon = Image.open ( "zoomi.png")
        altb = 40
        largb = 50
        ...
        #Botão zoom out
        zoomouticon = Image.open ( "zoomo.png")
        altb = 40
        largb = 50
        ...
        #Botão Microscopio
        microicon = Image.open ( "microsp.png")
        altb = 40
        largb = 50
        ...
        separa = Image.open ( "separa6.png")#carrega a imgem do separador
        altb = 15
        largb = 53
        ...
        fundo = Image.open ( "box.gif")#carrega uma imagem totalmente branca, que funciona como um plano de fndo inicial
        altb = 880
        largb = 1740
